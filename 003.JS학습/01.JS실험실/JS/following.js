...
function loadFn(){
  ...
  myBody.onmouseenter = () =>{mover.style.opacity = 1;}; /// mouseenter////
  myBody.onmouseleave = () =>{mover.style.opacity = 0;}; /// mouseleave////

...
function goR1(){
    ...
    //console.log(autoI); undefined
    
    // autoI변수에 할당 전 상태는 undefined 이므로 false처리됨
    // -> 이때 if문으로 들어가려면 !(NOT)연산자 사용
    if(!autoI){ //flase일 때 들어감
        //console.log('토끼실행',autoI); 
...
function whoWinner(){
    ...
    if(r1pos >= 650 || t1pos >= 650){
        ...
        //console.log('랜덤수:',rdmNum, '개수:',selMsg.length,'랜덤 메세지:',selMsg[rdmNum]);

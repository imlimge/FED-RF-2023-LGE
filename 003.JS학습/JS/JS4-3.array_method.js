//배열의 메서드 활용 JS4-3.array_method.js
...
// 1. 요구사항 : 배열에 과일정보를 담아서 '과일주세요' 버튼 클릭 시
...
console.log('버튼',mbtn,'변경',showit,cont,sel,anum,delNum);
...
//onsole.log(Object.keys(frObj).map(v=>frObj[v]));
...
function showFruit(){
  ...
  //          splice(순번,개수) -> 순번부터 개수만큼 삭제
    ...
    console.log(anum.value,delNum.value);

...
//1~2. JSX를 사용한 것과 JSX를 사용하지 않은 것을 비교////
...
//(1-3) 요소 출력하기: 생성된 루트에 render()를 붙여서 사용
root1.render(myEle1);
...
const myEle7 = <h1 className="myclass">className속성으로 클래스를 셋팅한다</h1>;

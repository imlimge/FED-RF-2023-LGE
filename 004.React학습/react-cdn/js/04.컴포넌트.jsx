...
// import시에 CND에서도 js/jsx 확장자는 생략가능함
...
function MakeImg(props){
  return(
    <img src={"./images/"+props.iname} alt="이미지" />
  );
}; //// MakeImg 컴포넌트 ///////
...
function Favorite(하){
  return(
    <h2>
      내가 좋아하는 색은 {하.color}이야 <br />
      그리고 좋아하는 음식은 {하.food}야! <br />
      취미는 {하.hobby}다 
    </h2>
  );
...
ReactDOM.render(
  <Favorite color="노란색" food="치킨" hobby="눕기"/>,document.querySelector('#root3')
);

// 함수 컴포넌트에서는 표현식 안에서 
//{props.호출시사용한속성명} 이 형식으로 전달된값을 읽음
//props => 아무거나 대체 가능한데 이걸로 보통 씀
...
ReactDOM.render(
  <Favorite color="빨강" food="햄버거" hobby="맥주"/>,document.querySelector('#root4')
);

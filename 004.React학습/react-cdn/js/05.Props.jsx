...
function AskMore(props){ //props.num 배열데이터 순번값
  ...
  // 컴포넌트에서 사용할 변수
  // 다른컴포넌트에서도 사용할 경우 컴포넌트 바깥쪽 전역구역에 코드를 넣는다

  // 옵션 배열변수 셋팅
  const carInfo = [
    {color:"라잇블루", model:"2023년형", opt:{filter:'hue-rotate(0deg)'}},
    {color:"녹차그린", model:"2024년형", opt:{filter:'hue-rotate(222deg)',transform:'rotateY(180deg)'}},
    {color:"코랄", model:"2022년형", opt:{filter:'hue-rotate(122deg)'}},

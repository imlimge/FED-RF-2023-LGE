...
// 컨텍스트 불러오기
import { 누구냐 } from "./02.sub_com2/cont_provider";


// 서브컴포넌트 불러오기
import 이야기 from "./02.sub_com2/sub_com";
...
// 일반적으로 props down 할 때 props 변수 하나를 써서
...
function 큰집(){
    ...
    // 컴포넌트도 업데이트 된다
    // 산이릉믈 상태변수 후크로 설정
     const [myVal,setMyVal] = React.useState('에베레스트');
    ...
    // Provider의 value 속성명은 정해진것
    // 여기에 할당하여 메인컴포넌트의 변수를
    // 공유한다
    return(

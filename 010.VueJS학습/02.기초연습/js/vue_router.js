...
// import시 중괄호{} 없이 변수쓰면 보내는 곳에서 default로 보내는 것
// 중괄호를 사용하여 변수를 쓰면 여러 변수를 보낼 수 있는 일반적인 export만 사용하는 경우임
...
// 실제로 사용할 것은 linkData2 (위의 linkData와 비교)
// 하위메뉴 구조화 데이터 객체
const linkData2 = {
    "세계여행사": {
        link:{ path: "/trip" },

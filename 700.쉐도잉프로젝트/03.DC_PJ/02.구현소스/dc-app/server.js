...
// **그러나 파일명이 겹쳐지므로 이것을 커스터마이징하여 변경하면 
// 자동으로 폴더를 생성하지 않으므로 
// 우리가 uploads라는 폴더를 생성해야 한다
// -> 배포 시 이 폴더가 생기도록 SPA 개발폴더의 public 아래에 
// uploads 폴더를 만들어 준다

// 파일명을 내가 원하는 원래 이름으로 들어가도록 변경함
// 멀터 스토리지의 저장소를 사용함
...
// home:'http://localhost:8080' 를 등록하여 사용 **************
...
// 첫 페이지는 요청에 대한 응답임. 파일을 내려보내주니까 sendFile()메서드 사용
